Feature: test a single turn with one reRolls
  ...
  Scenario Outline:
    ...
    Examples:
      ...
      | 109 |  SKULL    |  PARROT   |  PARROT   |  SKULL    |  MONKEY   |  PARROT   |  MONKEY   |  MONKEY   | SKULL     |  SKULL    |  SWORD    |  SKULL    |  MONKEY   |  SKULL    |  MONKEY   |  MONKEY   | SKULL     |  SKULL    |  SKULL    |  SKULL    |  SKULL    |  SKULL    |  SWORD    |  SKULL    | "125"  | "2467"    | 10          | 1000        | 1000           | 100         |
